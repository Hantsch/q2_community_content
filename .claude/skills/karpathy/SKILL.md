---
name: karpathy
description: Behavioral guidelines that reduce the four recurring LLM coding mistakes - overcomplication, collateral edits, silent assumptions, and vague success criteria. Use when writing, reviewing or refactoring code, when a task has more than one plausible reading, or when a change is about to touch code the request did not name.
license: MIT
---
